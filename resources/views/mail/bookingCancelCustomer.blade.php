                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        Booking for {{ $package_name }} ID: {{ $booking_number }} on {{ $booking_date }} at has been successfully cancelled.<br><br>

                                        If you need further assistance or wish to reschedule, please contact us.<br><br>
