                        ...
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    Dear {{ $first_name }}, your payment voucher against commission and incentive (if any) payable for the period {{ $month }} has been generated. Total: {{ $total_commission }}, TDS: {{ $tds }}, Net Payable: {{ $net_commission }}.<br><br>
                                          
                                            Thank you for your dedication!<br><br>
                                            Best regards,<br>
                                            WishMyTour
                                        </p>
                                    </td>
