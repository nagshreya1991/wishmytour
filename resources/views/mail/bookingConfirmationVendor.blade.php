                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        A new booking has been made! Booking ID: {{ $booking_number }}, Customer Name: {{ $customerName }} Package: {{ $packageName }} ,Date: {{ $firstBookingDate }}. Please confirm at your earliest convenience -From Wishmytour<br><br>
