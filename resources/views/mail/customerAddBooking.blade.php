                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            ...
                                            Good news! Your requested date for the <strong>{{ $tourName }}</strong> on <strong>{{ $requestedDate }}</strong> has been approved by our vendor.<br><br>

                                            You can now proceed with your booking by following the link below:<br><br>

                                            <a href="{{ $bookingLink }}" class="btn">Booking Link</a><br><br>

                                            We look forward to helping you plan a memorable trip!<br><br>
