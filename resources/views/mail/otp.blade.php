...
{{--                            </tr>--}}
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <h2 style="color:#1e1e2d; font-weight:700; margin:20px 0;font-size:24px;font-family:'Futura',sans-serif;">{{ $otp }}</h2>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                ...
                <tr>
                    <td><p style="color:#455056; font-size:12px;line-height:18px; margin:0;">
