                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Dear {{ $first_name }}, your invoice for the period {{ $period }} has been generated. Total Commission: {{ $total_commission }}. Incentive: {{ $incentive }}. <br><br>
                                            Here is the PDF Link: <a href="{{ $pdfFilePath }}" target="_blank">{{ $pdfFilePath }}</a> <br>
                                            Thank you for your efforts!<br><br>
                                            Best regards,<br>
                                            WishMyTour
                                        </p>
                                    </td>
