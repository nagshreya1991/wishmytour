...
<head>
    ...
    <meta name="description" content="Booking Declined Email Template.">
</head>
<style type="text/css">
    .btn {
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            ...
                                            Thank you for your interest in the <strong>{{ $tourName }}</strong>.<br><br>

                                            Unfortunately, the requested date of <strong>{{ $requestedDate }}</strong> is not available. We apologize for any inconvenience this may cause.<br><br>

                                            Please feel free to choose another date or browse our other exciting tour packages.<br><br>

                                            If you need any assistance, do not hesitate to contact us.<br><br>
